...
import type { SugangInwon, SugangMasterColumn, SugangDetailColumn } from '@/types/types';
...
const detailColumns: SugangDetailColumn[] = [
  ...
  { id: 'profname', label: '교수', width: 45 },
  { id: 'ta1', label: '타과1학년', width: 45 },
  { id: 'ta2', label: '타과2학년', width: 45 },
  { id: 'ta3', label: '타과3학년', width: 45 },
  { id: 'ta4', label: '타과4학년', width: 45 },
  { id: 'pyun', label: '편입', width: 45 },
  { id: 'jahaknean', label: '자과개설학년', width: 45 },
  { id: 'total', label: '총잔여인원', width: 45 },
  { id: 'pre_sugang', label: '장바구니인원', width: 45 },
];
...
export const SugangInwonTable: React.FC<{ sugangs: SugangInwon[] }> = ({ sugangs }) => {
  const {
    sortColumn,
    sortDirection,
    filters,
                  ...
                  <React.Fragment key={group.gwamokcode}>
                    ...
                    >
                      {masterColumns.map((col) => (
                        <TableCell key={col.id} style={{ width: columnWidths[col.id] }} className="truncate px-2 py-3">
                          {col.id === 'gwamokcode' ? (
                            <Button
                              variant={'ghost'}
                              ...
                              onClick={(e) => {
                                e.stopPropagation();
                                setSelectedCode(group.master.gwamokcode);
